...
public record RecordDetailsResponse(String id,
        DoctorSummaryResponse doctor, AppointmentSummaryResponse appointment,
        PatientSummaryResponse patient, String diagnosis, List<String> prescriptions, List<String> labResults,
